...
sed -i "s|minikube start --kubernetes-version=v1.20.7 -v=0 --cpus=2 --memory=4096|sudo minikube start --kubernetes-version=v1.20.7 -v=0 --cpus=2 --memory=4096  --vm-driver=none --bootstrapper=kubeadm|g" ./init_project.sh
